...
describe('Post e2e test', () => {
  ...
  const postSample = {
    tittle: 'Associate programming transmitter',
    content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=',
    date: '2023-10-02T09:38:51.287Z',
  };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="tittle"]`).type('coral').should('have.value', 'coral');
      ...
      cy.get(`[data-cy="date"]`).type('2023-10-02T07:30').blur().should('have.value', '2023-10-02T07:30');
