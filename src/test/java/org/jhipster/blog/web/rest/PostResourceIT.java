...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().tittle(DEFAULT_TITTLE).content(DEFAULT_CONTENT).date(DEFAULT_DATE);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().tittle(UPDATED_TITTLE).content(UPDATED_CONTENT).date(UPDATED_DATE);
        return post;
    }
    ...
    @Test
    @Transactional
    void checkTittleIsRequired() throws Exception {
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.tittle(UPDATED_TITTLE).content(UPDATED_CONTENT).date(UPDATED_DATE);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.tittle(UPDATED_TITTLE).content(UPDATED_CONTENT).date(UPDATED_DATE);
